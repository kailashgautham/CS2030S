...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> success = new Constant<>() {
    ...
    Constant<String> failure = new Constant<String>() {
    ...
    Immutator<Actually<Map<String, Map<String, String>>>, 
        Map<String, Map<String, Map<String, String>>>> getModule = new Immutator<>() {
          ...
          public Actually<Map<String, 
              Map<String, String>>> invoke(Map<String, Map<String, Map<String, String>>> modDB) {

            return Actually.ok(modDB.get(module));
    ...
    Immutator<Actually<Map<String, String>>, 
        Map<String, Map<String, String>>> getStudent = new Immutator<>() {
          ...
          @Override
          public Actually<Map<String, String>> invoke(Map<String, Map<String, String>> studentDB) {

            return Actually.ok(studentDB.get(student));

          }

        };

    Immutator<Actually<String>, Map<String, String>> getAssess = new Immutator<>() {

        @Override
        public Actually<String> invoke(Map<String, String> assessDB) {

            return Actually.ok(assessDB.get(assessment).toString());

        }

      };
      
    return success.init().next(getModule).next(getStudent).next(getAssess).except(failure);
  ...
  public static void test1() {
    ...
    System.out.println(
        Actually.err(new ArithmeticException("Err")).equals(Actually.err(new Exception(none))));
    System.out.println(
        Actually.err(new ArithmeticException(none)).equals(Actually.err(new Exception(none))));
  ...
  public static void test2() {
    ...
    System.out.println(
        Actually.<Number>err(new ArithmeticException("div by 0")).except(zero).toString());
    System.out.println(
        Actually.<Number>err(new ArithmeticException("div by 0")).unless(4).toString());

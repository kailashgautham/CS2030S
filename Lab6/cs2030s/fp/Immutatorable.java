...
/**
 * Represent a container that can transforms 
 * its content to produce another container 
 * containing the immutated element, 
...
public interface Immutatorable<T> {
   ...
   *
   * @param <R> the return type for Immutatorable.
